...
public final class SendGridEmailSender implements EmailSender {
    ...
    public SendGridEmailSender(String apiKey, String from) { this(apiKey, from, HttpClient.newBuilder().connectTimeout(CONNECT_TIMEOUT).build()); }
    SendGridEmailSender(String apiKey, String from, HttpClient client) { this.apiKey=apiKey; this.from=from; this.client=client; }
